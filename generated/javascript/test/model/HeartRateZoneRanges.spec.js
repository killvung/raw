...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HeartRateZoneRanges', function() {
      beforeEach(function() {
        instance = new StravaApiV3.HeartRateZoneRanges();
      });

      it('should create an instance of HeartRateZoneRanges', function() {
        // TODO: update the code to test HeartRateZoneRanges
        expect(instance).to.be.a(StravaApiV3.HeartRateZoneRanges);
      });
