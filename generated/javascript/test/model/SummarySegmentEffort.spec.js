  ...
  describe('(package)', function() {
    describe('SummarySegmentEffort', function() {
      ...
      it('should create an instance of SummarySegmentEffort', function() {
        // TODO: update the code to test SummarySegmentEffort
      ...
      it('should have the property isKom (base name: "is_kom")', function() {
        // TODO: update the code to test the property isKom
        expect(instance).to.have.property('isKom');
        // expect(instance.isKom).to.be(expectedValueLiteral);
      });
