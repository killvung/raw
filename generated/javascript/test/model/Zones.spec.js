...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Zones', function() {
      beforeEach(function() {
        instance = new StravaApiV3.Zones();
      });

      it('should create an instance of Zones', function() {
        // TODO: update the code to test Zones
        expect(instance).to.be.a(StravaApiV3.Zones);
      });

      it('should have the property heartRate (base name: "heart_rate")', function() {
