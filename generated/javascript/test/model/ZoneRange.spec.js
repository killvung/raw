...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ZoneRange', function() {
      beforeEach(function() {
        instance = new StravaApiV3.ZoneRange();
      });

      it('should create an instance of ZoneRange', function() {
        // TODO: update the code to test ZoneRange
        expect(instance).to.be.a(StravaApiV3.ZoneRange);
      });
