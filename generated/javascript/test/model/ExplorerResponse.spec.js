...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExplorerResponse', function() {
      beforeEach(function() {
        instance = new StravaApiV3.ExplorerResponse();
      });

      it('should create an instance of ExplorerResponse', function() {
        // TODO: update the code to test ExplorerResponse
        expect(instance).to.be.a(StravaApiV3.ExplorerResponse);
      });
