...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SummaryGear', function() {
      beforeEach(function() {
        instance = new StravaApiV3.SummaryGear();
      });

      it('should create an instance of SummaryGear', function() {
        // TODO: update the code to test SummaryGear
        expect(instance).to.be.a(StravaApiV3.SummaryGear);
      });
